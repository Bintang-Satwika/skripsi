...
class FJSPEnv(gym.Env):
    ...
    def __init__(self, window_size: int, num_agents: int, max_steps: int, episode: int):
        ...
        self.agent_speeds = [1, 1.2, 1.4]  # Agent2 1.5x lebih cepat; Agent3 2x lebih cepat
    ...
    def step(self, actions):
        ...
        reward_agent_all=-0.4+reward_wait_all+reward_working_all+reward_step_all+reward_accept_all
    ...
    def reward_accept(self, observations, k_accept=2):
        rewards=[]
    ...
    def reward_working(self, observations, is_status_working_succeed , k_working=0.03, k_energy=10):
        rewards=[]
        for r, agent in enumerate(self.agents):
           # obs=observations[r]
