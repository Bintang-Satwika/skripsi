from env_tanpa_yr2_part7 import FJSPEnv
import numpy as np
import random
...
if __name__ == "__main__":
    env = FJSPEnv(window_size=2, num_agents=3, max_steps=100, episode=1)
    rewards = {}
    makespan = {}
    energy= {}
    episode_seed=0
    for episode in range(1, 1+1):
        ...
        file_path = os.path.join(CURRENT_DIR, "Testing_FCFS_part4.json")
