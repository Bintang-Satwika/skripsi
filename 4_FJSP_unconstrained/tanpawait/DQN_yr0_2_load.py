...
class DDQN_model:
    def __init__(self,
        ...
        self.save_dir = os.path.join(self.current_dir, 'DQN_yr0_2_098')
        ...
        self.load_models(self.save_dir, episode_load)

        self.dqn_optimizer = tf.keras.optimizers.Adam(learning_rate=self.lr)
        
        replay_buffer_path = os.path.join(self.current_dir, 'DQN_yr0_2_098', f'replay_buffer_episode_{self.episode_load}.pkl')
