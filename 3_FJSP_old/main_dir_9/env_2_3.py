...
class FJSPEnv(gym.Env):
    ...
    def reward_accept(self, observations, k_accept=1):
        rewards=[]
    ...
    def reward_working(self, observations, is_status_working_succeed , k_working=2.0, k_energy=1.0):
        rewards=[]
        for r, agent in enumerate(self.agents):
           # obs=observations[r]
    ...
    def reward_complete(self, k_complete=10.0):
