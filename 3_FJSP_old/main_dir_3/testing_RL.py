...
def run_env(num_episodes, render):
    ...
    file_path= os.path.join(CURRENT_DIR, "Testing_cumulative_rewards_RL_100_env1_50ep.json")
    with open(file_path, "w") as f:
        json.dump(rewards, f, indent=4)
    file_path= os.path.join(CURRENT_DIR, "Testing_makespan_RL_100_env1_50ep.json")
    with open(file_path, "w") as f:
