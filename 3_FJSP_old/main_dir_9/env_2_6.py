...
class FJSPEnv(gym.Env):
    ...
    def step(self, actions):
        ...
        reward_agent_all=-0.2+reward_wait_all+reward_working_all+reward_step_all+reward_accept_all
    ...
    def reward_working(self, observations, is_status_working_succeed , k_working=0.25, k_energy=10):
        rewards=[]
        for r, agent in enumerate(self.agents):
           # obs=observations[r]
