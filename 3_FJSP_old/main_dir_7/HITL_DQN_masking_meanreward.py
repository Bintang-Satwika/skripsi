...
class DDQN_model:
    def __init__(self,
        ...
        self.save_dir = os.path.join(self.current_dir, 'model_HITL_Masking_21_400')
    ...
    for episode in tqdm(range(DDQN.episode_load+1, num_episodes + 1)):
        ...
        while not done:
            ...
            if episode < DDQN.episode_hitl:
                ...
                human_actions, mask_actions = DDQN.human_in_the_loop(state, state_normalized, joint_actions, reward_episode,env, episode)
