...
from circular_conveyor_testing_1 import CircularConveyor
...
class FJSPEnv(gym.Env):
    ...
    def __init__(self, window_size: int, num_agents: int, max_steps: int):
        ...
        self.base_processing_times = [48, 48, 48]  #  waktu dasar untuk setiap operasi
    ...
    def reward_complete(self, k_complete=1.0):
