...
from RULED_BASED import MASKING_action, RANDOM_action
...
class DDQN_model:
    def __init__(self,
        ...
        self.save_dir = os.path.join(self.current_dir, 'DQN_yr0_independen_1')
...
if __name__ == "__main__":
    ...
    for ep in tqdm(range(DDQN.episode_load+1, 601)):
