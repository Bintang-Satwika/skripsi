...
class FJSPEnv(gym.Env):
    ...
    def __init__(self, window_size: int, num_agents: int, max_steps: int, episode: int):
        ...
        self.state_first_job_operation_location=[7] # yr
        self.state_second_job_operation_location=[8] # yr
        #---------------------------------------------------------------------
    ...
    def step(self, actions):
        ...
        reward_agent_all=-0.25+reward_working_all+reward_step_all+reward_accept_all
    ...
    def reward_working(self, observations, is_status_working_succeed , k_working=3 , k_energy=1):
        rewards=[]
        for r, agent in enumerate(self.agents):
           # obs=observations[r]
