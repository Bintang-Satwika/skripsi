...
MODEL_DIR = os.path.join(PARENT_DIR,'main_dir_5', "model_HITL_Masking_9")
...
def run_env(num_episodes, render):
    ...
    file_path= os.path.join(CURRENT_DIR, "Testing_cumulative_rewards_HITL.json")
    with open(file_path, "w") as f:
        json.dump(rewards, f, indent=4)
    file_path= os.path.join(CURRENT_DIR, "Testing_makespan_HITL.json")
    with open(file_path, "w") as f:
