...
class FJSPEnv(gym.Env):
    ...
    def step(self, actions):
        ...
        reward_agent_all=-0.1+reward_wait_all+reward_working_all+reward_step_all
    ...
    # def reward_energy(self, observations, k_energy=0.1):
    #     rewards=[]
    #     for r, agent in enumerate(self.agents):
    #         if  self.is_status_working_succeed[r]:
    #             rewards.append(k_energy-np.divide(
    #                                     float(agent.speed), 
    #                                     np.sum(self.agent_speeds)
    #                                     )
    #                             )
    #         else:
    #             rewards.append(0)
    ...
    def reward_working(self, observations, is_status_working_succeed , k_working=0.1, k_energy=1):
        rewards=[]
        for r, agent in enumerate(self.agents):
           # obs=observations[r]
            if self.is_status_working_succeed[r]:
