...
MODEL_DIR = os.path.join(PARENT_DIR,'tanpawait_decentralized', "DQN_decentralized_1")
...
def run_env(num_episodes, render):
    ...
    for episode in range(1, num_episodes+1):
        ...
        file_path = os.path.join(CURRENT_DIR, "Testing_DQN_decent_tanpawait_200ep.json")
