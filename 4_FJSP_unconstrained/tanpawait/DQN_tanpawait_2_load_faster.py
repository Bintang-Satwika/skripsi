...
class DDQN_model:
    def __init__(self,
        ...
        self.save_dir = os.path.join(self.current_dir, 'DQN_tanpawait_2')
        ...
        replay_buffer_path = os.path.join(self.save_dir, f'replay_buffer_episode_{self.episode_load}.pkl')
