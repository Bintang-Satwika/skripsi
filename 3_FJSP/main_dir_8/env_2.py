...
class FJSPEnv(gym.Env):
    ...
    def step(self, actions):
        ...
        reward_agent_all=-0.75+reward_wait_all+reward_working_all+reward_step_all
    ...
    def reward_working(self, observations, is_status_working_succeed , k_working=1.5, k_energy=1):
        rewards=[]
        for r, agent in enumerate(self.agents):
           # obs=observations[r]
            if self.is_status_working_succeed[r]:
