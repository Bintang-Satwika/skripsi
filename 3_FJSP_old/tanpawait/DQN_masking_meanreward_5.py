...
from env_tanpawait_2 import FJSPEnv  # Your flexible job shop environment
...
class DDQN_model:
    def __init__(self,
        ...
        self.save_dir = os.path.join(self.current_dir, 'DQN_tanpawait_5')
