...
MODEL_DIR = os.path.join(PARENT_DIR,'tanpawait', "DQN_tanpawait_1")
...
def run_env(num_episodes, render):
    env = FJSPEnv(window_size=1, num_agents=3, max_steps=3000, episode=1)
    num_episodes = 200
    rewards = {}
    makespan = {}
    energy= {}
    for episode in range(1, num_episodes+1):
        ...
        file_path = os.path.join(CURRENT_DIR, "Testing_DQN_tanpawait_200ep_2.json")
