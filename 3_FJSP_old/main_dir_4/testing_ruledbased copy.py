from env_testing import FJSPEnv
import numpy as np
import random
...
if __name__ == "__main__":
    ...
    file_path= os.path.join(CURRENT_DIR, "Testing_cumulative_rewards_F.json")
    with open(file_path, "w") as f:
        json.dump(rewards, f, indent=4)
    file_path= os.path.join(CURRENT_DIR, "Testing_makespan_F.json")
    with open(file_path, "w") as f:
