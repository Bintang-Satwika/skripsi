...
class DDQN_model:
    def __init__(self,
        ...
        self.save_dir = os.path.join(self.current_dir, 'model_RL_2')
    ...
    def train_double_dqn(self):
        ...
        with tf.GradientTape() as tape:
            ...
            mb_actions_next = tf.stop_gradient(tf.argmax(masked_mb_Q_values_next, axis=2))  # shape (batch, num_agents)
