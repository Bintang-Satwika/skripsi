...
MODEL_DIR = os.path.join(PARENT_DIR,'tanpawait_decentralized_independen', "DQN_1")
...
def run_env(num_episodes, render):
    ...
    for episode in range(1, num_episodes+1):
        ...
        while not done:
            ...
            all_states_normalized = normalize(all_states_DQN) # Normalize the state
        ...
        file_path = os.path.join(CURRENT_DIR, "Testing_DQN_decent_independen_200ep.json")
