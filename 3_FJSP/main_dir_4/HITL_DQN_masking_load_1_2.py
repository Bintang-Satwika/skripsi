...
class DDQN_model:
    def __init__(self,
        ...
        self.save_dir = os.path.join(self.current_dir, 'model_HITL_Masking_6d')
        ...
        self.dqn_network, self.target_dqn_network = self.load_models(load_dir=os.path.join(self.current_dir, 
                                                                    'model_HITL_Masking_6c'),
