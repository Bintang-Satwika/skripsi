...
MODEL_DIR = os.path.join(PARENT_DIR,'main_dir_9', "model_RANDOM_priority_7")
...
def run_env(num_episodes, render):
    ...
    for episode in range(1, 30+1):
        ...
        while not (done or truncated):
            ...
            state_normalized = normalize(state_RL)
        ...
        file_path = os.path.join(CURRENT_DIR, "Testing_RL_5.json")
