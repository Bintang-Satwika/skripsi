''' reward diubah jadi -1 dan +1 untuk penalti dan untuk proccess done
 job jadi 21,  self.product_operations = {
            "A": [1,2,3],
            "B": [1,3],
            "C": [3],
        }
...
from env_5c_3 import FJSPEnv  # Your flexible job shop environment
...
class DDQN_model:
    def __init__(self,
        ...
        self.save_dir = os.path.join(self.current_dir, 'saved_4')
...
# Helper function for action masking (similar logic as before)
...
if __name__ == "__main__":
    ...
    for episode in tqdm(range(1, num_episodes + 1)):
        ...
        while not done:
            ...
            reward_episode += np.mean(reward)  # you can also sum rewards per agent
