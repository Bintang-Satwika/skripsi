...
class Agent:
    def __init__(self, agent_id: int, position: int, operation_capability : list, speed : float,  window_size: int, num_agent: int):
        ...
        self.status_all = [0]*1   # Status hanya 1  robot (0: idle, 1: accepting job, 2: working, 3: completing job)
    ...
    def processing_time(self, base_processing_time, select_operation):
        return math.ceil(base_processing_time / self.speed[select_operation])
