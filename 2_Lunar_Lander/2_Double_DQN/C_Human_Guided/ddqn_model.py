...
class DDQNLoader:
    def __init__(self, state_dim=8, action_dim=4, load_dir='file_path'):
...
if __name__ == "__main__":
    loader = DDQNLoader(state_dim=8, action_dim=4,load_dir='D:\\KULIAH\\skripsi\\CODE\\skripsi\\double_dqn\\highwaymodel_1')
